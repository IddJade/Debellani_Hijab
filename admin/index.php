...
<div class="w3-main" style="margin-left:340px; padding:10px; background-color: white;margin-right:40px;box-shadow: 10px 10px grey; border-bottom-right-radius: 50px 20px;">
